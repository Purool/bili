//
//  ZFNormalViewController.swift
//  bili
//
//  Created by DJ on 2024/9/20.
//
...
private let kButtonY = kTopMargin + kScreenWidth_9_16 + 40
...
class ZFNoramlViewController: UIViewController {
    ...
    private lazy var containerView: UIImageView = {
        let containerView = UIImageView(frame: CGRect(origin: CGPoint(x: 0, y: kTopMargin), size: CGSize(width: kScreenWidth, height: kScreenWidth_9_16)))
        containerView.setImageWithURLString(kVideoCover, placeholder: ZFUtilities.image(with: .darkGray, size: CGSize(width: 1, height: 1)))
    ...
    private lazy var  playBtn: UIButton = {
        ...
        btn.frame.origin = CGPoint(x: kScreenWidth / 2 - 22, y: kScreenWidth_9_16 / 2 - 22)
    ...
    private lazy var  nextBtn: UIButton = { [weak self] in
        ...
        btn.addTarget(self, action: #selector(self?.nextBtnClick), for: .touchUpInside)
        btn.sizeToFit()
        return btn
    }()

    private lazy var assetURLs: [URL]  = [URL(string: "https://www.apple.com/105/media/cn/mac/family/2018/46c4b917_abfd_45a3_9b51_4e3054191797/films/bruce/mac-bruce-tpl-cn-2018_1280x720h.mp4")!]
